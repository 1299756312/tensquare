...
public class ProblemController {
    ...
    public Result findWaitListByLabelId(@PathVariable String labelid,
        ...
        Page<Problem> pages = problemService.findHotListByLabelId(labelid, page, size);
        PageResult<Problem> pageResult = new PageResult<>(pages.getTotalElements(), pages.getContent());
